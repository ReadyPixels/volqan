...
Volqan is an open-core, source-available project. Commercial planning lives in [BUSINESS.md](./BUSINESS.md) so this README can stay focused on what Volqan is, how to run it, and the current project state.
