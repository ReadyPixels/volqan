 ...
 */
export type ContentHookName = 'beforeCreate' | 'afterCreate' | 'beforeUpdate' | 'afterUpdate' | 'beforeDelete' | 'afterDelete' | 'beforePublish' | 'afterPublish';
...
export type HookPayload = BeforeCreatePayload | AfterCreatePayload | BeforeUpdatePayload | AfterUpdatePayload | BeforeDeletePayload | AfterDeletePayload | BeforePublishPayload | AfterPublishPayload;
/**
 ...
 */
export type HookHandler<P extends HookPayload = HookPayload> = (payload: P) => void | P | Promise<void> | Promise<P>;
/**
...
export declare class HookRegistry {
     ...
     */
    register<P extends HookPayload>(name: ContentHookName, handler: HookHandler<P>, priority?: number): () => void;
    /**
     ...
     */
    fire<P extends HookPayload>(name: ContentHookName, payload: P): Promise<P>;
    /**
