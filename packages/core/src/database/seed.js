...
async function hashPassword(plain) {
    ...
    try {
        ...
        console.error('[volqan:seed] bcryptjs not found — password will NOT be usable. ' +
...
async function seedSuperAdmin() {
    ...
    if (existing) {
        console.info(`[volqan:seed] Super admin already exists (${DEFAULT_ADMIN_EMAIL}) — skipping.`);
        return;
    }
    ...
    console.warn(`[volqan:seed] ⚠  Default password is "${DEFAULT_ADMIN_PASSWORD}". ` +
...
async function seedInstallation() {
    ...
    console.info(`[volqan:seed] Created installation record (id: ${installation.installationId})`);
}
/**
